  ...
  return (
    <div className="relative group rounded-md overflow-hidden cursor-pointer shadow-lg bg-surface-light border border-white/10">
      ...
      <div className="absolute inset-x-0 bottom-0 p-3 bg-gradient-to-t from-black via-black/80 to-transparent">
        <div className="h-4 bg-surface-container-high rounded animate-pulse w-3/4 mb-1"></div>
        <div className="flex items-center justify-between">
           <div className="h-3 bg-surface-container-high rounded animate-pulse w-1/3"></div>
      ...
      <div className="absolute top-2 left-2 flex gap-1 z-10">
         <div className="w-12 h-5 bg-surface-container-high rounded animate-pulse"></div>
         <div className="w-8 h-5 bg-surface-container-high rounded animate-pulse"></div>
      </div>
    </div>
  );
};
